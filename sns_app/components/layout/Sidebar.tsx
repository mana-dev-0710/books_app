...
const Sidebar = () => {
  ...
  return (
    <div className="w-full">
      <div className="memo relative px-4 pt-6 pb-4 bg-white shadow-md">
        ...
        <div className="px-2 py-4 mb-2 text-sm">
          <ul className="grid grid-cols-2 gap-2 text-sm">
            <li className="col-span-2 text-center font-semibold">ユーザー名</li>
            <li className="col-span-2">総読書冊数：</li>
            <li className="col-span-2">総読書ページ数：</li>
            <li className="col-span-2">総評価冊数：</li>
          </ul>
        </div>
      </div>
      {/* メニューリスト */}
      <div className="px-3 py-8">
        <ul className="grid grid-cols-1 gap-2 text-sm">
          ...
          <li className="font-semibold">
            <button type="button" className="inline-flex items-center gap-x-2 py-1 px-2 w-full justify-center rounded-md text-white bg-primary-400 hover:bg-primary-500 hover:shadow hover:shadow-gray">マイ本棚</button>
          </li>
          <li className="font-semibold">
