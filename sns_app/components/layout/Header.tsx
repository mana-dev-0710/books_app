  ...
  render () {
    return(
      <header className="sticky top-0 z-50">
        <nav className="flex items-center justify-between flex-wrap bg-primary-600 px-4 py-2 text-white">
          ...
          <div className="text-sm align-content-center">
            {/* TODO:ログイン時の表示処理 */}
            ...
            <button className="bg-secondary-400 hover:bg-secondary-500 text-white py-1 px-2 rounded-md hover:shadow hover:shadow-black">ログイン</button>
          </div>
        </nav>
      </header>
    );
